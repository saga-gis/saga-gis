...
['imagery_classification', 2, 'Change Detection'],
...
['ta_hydrology', 0, 'Catchment Area (Top-Down)'],
['ta_hydrology', 1, 'Catchment Area (Recursive)'],
['ta_hydrology', 2, 'Catchment Area (Flow Tracing)'],
...
['ta_hydrology', 18, 'Catchment Area (Mass-Flux Method)'],
