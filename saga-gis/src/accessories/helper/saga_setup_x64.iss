; To build installer (for example, saga-9.4.2_setup.exe).
; - Unzip the SAGA binary files in their own folder (for example, saga-9.4.2.zip).
...
OutputDir=.
OutputBaseFilename=saga-9.4.2_x64_setup

VersionInfoVersion=9.4.2.0
...
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA\9.4.2"; ValueType: string; ValueName: "InstallDir"; ValueData: "{app}"; Flags: uninsdeletekey
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA\9.4.2"; ValueType: string; ValueName: "Version"; ValueData: "9.4.2.0"
