; To build installer (for example, saga-9.3.3_setup.exe).
; - Unzip the SAGA binary files in their own folder (for example, saga-9.3.3.zip).
...
OutputDir=.
OutputBaseFilename=saga-9.3.3_x64_setup

VersionInfoVersion=9.3.3.0
...
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA\9.3.3"; ValueType: string; ValueName: "InstallDir"; ValueData: "{app}"; Flags: uninsdeletekey
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA\9.3.3"; ValueType: string; ValueName: "Version"; ValueData: "9.3.3.0"
