; To build installer (for example, saga-9.9.0_setup.exe).
; - Unzip the SAGA binary files in their own folder (for example, saga-9.9.0.zip).
...
OutputDir=.
OutputBaseFilename=saga-9.9.0_x64_setup
...
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA\9.9.0"; ValueType: string; ValueName: "InstallDir"; ValueData: "{app}"; Flags: uninsdeletekey
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA\9.9.0"; ValueType: string; ValueName: "Version"; ValueData: "9.9.0.0"
