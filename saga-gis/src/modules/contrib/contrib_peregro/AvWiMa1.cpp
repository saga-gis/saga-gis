/**********************************************************
 * Version $Id: AvWiMa1.cpp 911 2011-02-14 16:38:15Z reklov_w $
 *********************************************************/
...
//---------------------------------------------------------
CAvWiMa1::CAvWiMa1(void)
{
	// 1. Info...
	Set_Name(_TL("Average With Mask 1"));
	Set_Author(_TL("Alessandro Perego"));
	Set_Description(_TL("Average With Mask 1 calculates average for cells specified by a mask grid. Cell excluded by the mask grid are NOT used in the average calculation."));
	...
	Parameters.Add_Grid(NULL, "RESULT", _TL("AWM1 Grid"), _TL("New grid filtered with the AvWiMa1 module"), PARAMETER_OUTPUT);
