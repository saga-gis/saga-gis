...
//---------------------------------------------------------
class CGrid_Addition : public CSG_Tool_Grid
{
public:
	CGrid_Addition(void);
...
//---------------------------------------------------------
class CGrid_Subtraction : public CSG_Tool_Grid
{
public:
	CGrid_Subtraction(void);
...
//---------------------------------------------------------
class CGrid_Multiplication : public CSG_Tool_Grid
{
public:
	CGrid_Multiplication(void);
