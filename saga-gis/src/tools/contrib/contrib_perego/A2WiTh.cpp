/**********************************************************
 * Version $Id: A2WiTh.cpp 911 2011-02-14 16:38:15Z reklov_w $
 *********************************************************/
...
CA2WiTh::CA2WiTh(void)
{
	...
	Parameters.Add_Grid(NULL, "RESULT", _TL("AWT Grid"), _TL("New grid filtered with the A2WiTh tool"), PARAMETER_OUTPUT);
