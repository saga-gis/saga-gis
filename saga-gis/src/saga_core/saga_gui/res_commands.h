...
enum ID_COMMANDS
{
	...
	ID_CMD_TOOL_RECENT_LAST		= RECENT_COUNT + ID_CMD_TOOL_RECENT_FIRST,
	ID_CMD_TOOL_OPEN,
	ID_CMD_TOOL_RELOAD,
	ID_CMD_TOOL_SEARCH,
	...
	ID_CMD_GRID_FIRST,
	ID_CMD_GRID_RECENT_FIRST,
	ID_CMD_GRID_RECENT_LAST		= RECENT_COUNT + ID_CMD_GRID_RECENT_FIRST,
	ID_CMD_GRID_OPEN,
	ID_CMD_GRID_SAVEAS_IMAGE,
	ID_CMD_GRID_CLIPBOARD_IMAGE,
	ID_CMD_GRID_SHOW,
	ID_CMD_GRID_HISTOGRAM,
	ID_CMD_GRID_SCATTERPLOT,
	ID_CMD_GRID_EQUALINTERVALS,
	ID_CMD_GRID_SET_LUT,
	ID_CMD_GRID_SEL_CLEAR,
	ID_CMD_GRID_SEL_DELETE,
	ID_CMD_GRID_LAST,
	...
	ID_CMD_TABLE_FIRST,
	ID_CMD_TABLE_RECENT_FIRST,
	ID_CMD_TABLE_RECENT_LAST		= RECENT_COUNT + ID_CMD_TABLE_RECENT_FIRST,
	ID_CMD_TABLE_OPEN,
	ID_CMD_TABLE_SHOW,
	ID_CMD_TABLE_DIAGRAM,
	ID_CMD_TABLE_SCATTERPLOT,
	...
	//-----------------------------------------------------
	ID_CMD_CHILD_FIRST,	// Begin: Child Window Commands
	...
	ID_CMD_LAYOUT_ITEM_PASTE,
	ID_CMD_LAYOUT_MOVE_TOP,
	ID_CMD_LAYOUT_MOVE_BOTTOM,
	ID_CMD_LAYOUT_MOVE_UP,
	ID_CMD_LAYOUT_MOVE_DOWN,
	ID_CMD_LAYOUT_PROPERTIES,
	ID_CMD_LAYOUT_DELETE,
	ID_CMD_LAYOUT_LAST,

	ID_CMD_CHILD_LAST,	// End: Child Window Commands

	//-----------------------------------------------------
	ID_CMD_TOOL_MENU_FIRST,	// Begin: Tool Commands
	ID_CMD_TOOL_MENU_RECENT_FIRST,
	ID_CMD_TOOL_MENU_RECENT_LAST	= RECENT_COUNT + ID_CMD_TOOL_MENU_RECENT_FIRST,
	ID_CMD_TOOL_MENU_START,
	ID_CMD_TOOL_MENU_LAST			= ID_CMD_TOOL_MENU_START + 2048	// End: Tool Commands
};
