...
enum ID_COMMANDS
{
	...
	ID_CMD_DATA_FILE_RECENT_LAST = RECENT_COUNT + ID_CMD_DATA_FILE_RECENT_FIRST,
    ...
    ID_CMD_SHAPES_EDIT_SEL_COPY_TO_NEW_LAYER,
	ID_CMD_SHAPES_LAST,
