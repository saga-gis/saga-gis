...
OutputDir=.
OutputBaseFilename=saga_2.0.4_setup

VersionInfoVersion=2.0.4.0
VersionInfoCompany=SAGA User Group Association
VersionInfoCopyright=(c) 2005-2009 by O. Conrad
...
Source: "*.*"; Excludes: "*.iss,*.ini,*.bak,*.exe,*.bat,*.rtf"; DestDir: "{app}"
Source: "modules\*.*"; DestDir: "{app}\modules"

[Icons]
; Start up in modules folder so SAGA will load all modules automatically.
Name: "{commonprograms}\SAGA GIS"; Filename: "{app}\saga_gui.exe"; WorkingDir: "{app}\modules"
Name: "{commondesktop}\SAGA GIS"; Filename: "{app}\saga_gui.exe"; WorkingDir: "{app}\modules"
...
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA GIS\2.0.3"; ValueType: string; ValueName: "InstallDir"; ValueData: "{app}"; Flags: uninsdeletekey
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA GIS\2.0.3"; ValueType: string; ValueName: "Version"; ValueData: "2.0.3.0"
