...
OutputDir=.
OutputBaseFilename=saga_2.0.7_win32_setup

VersionInfoVersion=2.0.7.0
VersionInfoCompany=SAGA User Group Association
VersionInfoCopyright=(c) 2005-2011 by O. Conrad
...
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA GIS\2.0.7"; ValueType: string; ValueName: "InstallDir"; ValueData: "{app}"; Flags: uninsdeletekey
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA GIS\2.0.7"; ValueType: string; ValueName: "Version"; ValueData: "2.0.7.0"
