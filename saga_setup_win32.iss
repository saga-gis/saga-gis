; To build installer (for example, saga-7.1.0_setup.exe).
; - Unzip the SAGA binary files in their own folder (for example, saga-7.1.0.zip).
...
OutputDir=.
OutputBaseFilename=saga-7.1.0_win32_setup
