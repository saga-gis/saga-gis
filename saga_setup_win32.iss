...
OutputDir=.
OutputBaseFilename=saga_2.2.8_win32_setup
...
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA GIS\2.2.8"; ValueType: string; ValueName: "InstallDir"; ValueData: "{app}"; Flags: uninsdeletekey
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA GIS\2.2.8"; ValueType: string; ValueName: "Version"; ValueData: "2.2.8.0"
