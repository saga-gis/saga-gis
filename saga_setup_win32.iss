...
OutputDir=.
OutputBaseFilename=saga_2.2.4_win32_setup
...
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA GIS\2.2.4"; ValueType: string; ValueName: "InstallDir"; ValueData: "{app}"; Flags: uninsdeletekey
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA GIS\2.2.4"; ValueType: string; ValueName: "Version"; ValueData: "2.2.4.0"
