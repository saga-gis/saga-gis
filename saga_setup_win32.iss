...
OutputDir=.
OutputBaseFilename=saga_2.0.8_win32_setup
...
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA GIS\2.0.8"; ValueType: string; ValueName: "InstallDir"; ValueData: "{app}"; Flags: uninsdeletekey
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA GIS\2.0.8"; ValueType: string; ValueName: "Version"; ValueData: "2.0.8.0"
