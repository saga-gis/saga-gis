; To build installer (for example, saga-7.2.0_setup.exe).
; - Unzip the SAGA binary files in their own folder (for example, saga-7.2.0.zip).
...
OutputDir=.
OutputBaseFilename=saga-7.2.0_win32_setup
...
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA GIS\7.2.0"; ValueType: string; ValueName: "InstallDir"; ValueData: "{app}"; Flags: uninsdeletekey
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA GIS\7.2.0"; ValueType: string; ValueName: "Version"; ValueData: "7.2.0.0"
