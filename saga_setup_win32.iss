...
OutputDir=.
OutputBaseFilename=saga-6.3.0_win32_setup
...
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA GIS\6.3.0"; ValueType: string; ValueName: "InstallDir"; ValueData: "{app}"; Flags: uninsdeletekey
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA GIS\6.3.0"; ValueType: string; ValueName: "Version"; ValueData: "6.3.0.0"
