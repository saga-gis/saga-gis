...
void		Create_Example	(void)
{
	...
	if( (Stream = fopen(FileName, "w")) != NULL )
	{
		fprintf(Stream,
			...
			"echo ;-)\n"
			"\n"
			"saga_cmd.exe Grid_Shapes                  0 -INPUT .\\dem.dgm -CONTOUR .\\contour.shp -ZSTEP 25.0\n"
			"saga_cmd.exe Terrain_Analysis_Morphometry 3 -ELEVATION .\\dem.dgm -SLOPE .\\slope.dgm -ASPECT .\\aspect.dgm -HCURV .\\hcurv.dgm -VCURV .\\vcurv.dgm\n"
			"saga_cmd.exe Terrain_Analysis_Flow        0 -ELEVATION .\\dem.dgm -CAREA .\\carea.dgm\n"
			"saga_cmd.exe Terrain_Analysis_Indices     1 -SLOPE .\\slope.dgm -AREA .\\carea.dgm -WETNESS .\\wetness.dgm -STREAMPOW .\\streampow.dgm -LSFACTOR .\\lsfactor.dgm\n"
			"saga_cmd.exe Terrain_Analysis_Lighting    0 -ELEVATION .\\dem.dgm -SHADE .\\shade.dgm -METHOD 0 -AZIMUTH -45 -DECLINATION 45\n"
			"\n"
			"echo _____________________________________________\n"
			"echo SAGASAGASAGASAGASAGASAGASAGASAGASAGASAGASAGAS\n"
			...
			"echo ;-)\n"
			"\n"
			"saga_cmd.exe Grid_Discretisation          0 -INPUT .\\dem.dgm;.\\slope.dgm;.\\aspect.dgm;.\\hcurv.dgm;.\\vcurv.dgm -RESULT .\\cluster.dgm -STATISTICS cluster.txt -NORMALISE -NCLUSTER 10\n"
			"\n"
			"echo _____________________________________________\n"
			"echo SAGASAGASAGASAGASAGASAGASAGASAGASAGASAGASAGAS\n"
