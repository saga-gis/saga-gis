...
# ADD CPP /nologo /G5 /MD /W3 /GX /O2 /I "$(GDAL)/include" /I "$(GDAL)/gcore" /I "$(GDAL)/ogr" /I "$(GDAL)/ogr/ogrsf_frmts" /I "$(SAGA)/src/saga_core" /D "NDEBUG" /D "WIN32" /D "_USRDLL" /D "_MBCS" /D "_TYPEDEF_BYTE" /D "_TYPEDEF_WORD" /D "_SAGA_MSW" /D "_SAGA_VC" /YX /FD /c
