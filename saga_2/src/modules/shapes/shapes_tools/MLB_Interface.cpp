...
const char * Get_Info(int i)
{
	...
	case MLB_INFO_Author:
		return( _TL("Olaf Conrad, Victor Olaya (c) 2002-4") );
...
CModule *		Create_Module(int i)
{
	...
	{
	case 0:
		pModule	= new CShapes_Create_Empty;
		break;

	case 1:
		pModule	= new CShapes_Assign_Table;
		break;

	case 2:
		pModule	= new CShapes_Merge;
		break;

	case 3:
		pModule	= new CNewLayerFromSelectedShapes;
		break;

	case 4:
		pModule	= new CQueryBuilder;
		break;

	case 5:
		pModule	= new CSearchInTable;
		break;

	case 6:
		pModule	= new CSelectByTheme;
		break;

	case 7:
		pModule	= new CSeparateShapes;
		break;

	case 8:
		pModule	= new CTransformShapes;
		break;

	case 9:
		pModule = new CCreateChartLayer;
		break;

	case 10:
		pModule = new CGraticuleBuilder;
		break;

	case 11:
		pModule = new CShapes_Report;
		break;

	case 12:
		pModule = new CSummarize;
		break;

	case 13:
		pModule = new CCreateWebContent;
		break;
