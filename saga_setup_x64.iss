; To build installer (for example, saga-9.1.3_setup.exe).
; - Unzip the SAGA binary files in their own folder (for example, saga-9.1.3.zip).
...
OutputDir=.
OutputBaseFilename=saga-9.1.3_x64_setup
...
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA\9.1.3"; ValueType: string; ValueName: "InstallDir"; ValueData: "{app}"; Flags: uninsdeletekey
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA\9.1.3"; ValueType: string; ValueName: "Version"; ValueData: "9.1.3.0"
