...
OutputDir=.
OutputBaseFilename=saga_2.1.1_x64_setup
...
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA GIS\2.1.1"; ValueType: string; ValueName: "InstallDir"; ValueData: "{app}"; Flags: uninsdeletekey
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA GIS\2.1.1"; ValueType: string; ValueName: "Version"; ValueData: "2.1.1.0"
