...
OutputDir=.
OutputBaseFilename=saga_2.1.3_x64_setup
...
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA GIS\2.1.3"; ValueType: string; ValueName: "InstallDir"; ValueData: "{app}"; Flags: uninsdeletekey
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA GIS\2.1.3"; ValueType: string; ValueName: "Version"; ValueData: "2.1.3.0"
