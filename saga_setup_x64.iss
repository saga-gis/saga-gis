...
OutputDir=.
OutputBaseFilename=saga_2.1.4_x64_setup

VersionInfoVersion=2.1.4.0
VersionInfoCompany=SAGA User Group Association
VersionInfoCopyright=(c) 2005-2010 by O. Conrad
...
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA GIS\2.1.4"; ValueType: string; ValueName: "InstallDir"; ValueData: "{app}"; Flags: uninsdeletekey
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA GIS\2.1.4"; ValueType: string; ValueName: "Version"; ValueData: "2.1.4.0"
